...
export async function GET() {
  ...
  try {
    ...
    console.log('Environment check:', {
      PIPEDREAM_API_KEY: process.env.PIPEDREAM_API_KEY ? '[REDACTED]' : 'undefined',
      NEXT_PUBLIC_PIPEDREAM_API_KEY: process.env.NEXT_PUBLIC_PIPEDREAM_API_KEY ? '[REDACTED]' : 'undefined',
      PIPEDREAM_CLIENT_SECRET: process.env.PIPEDREAM_CLIENT_SECRET ? '[REDACTED]' : 'undefined',
