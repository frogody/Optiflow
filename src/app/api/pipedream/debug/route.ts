...
export async function GET() {
  ...
  const filteredEnv = {
    ...
    PIPEDREAM_PROJECT_ENVIRONMENT: process.env.PIPEDREAM_PROJECT_ENVIRONMENT || '[NOT SET]',
    
    // Public variables
    NEXT_PUBLIC_PIPEDREAM_CLIENT_ID: process.env.NEXT_PUBLIC_PIPEDREAM_CLIENT_ID ? '[SET]' : '[NOT SET]',
    NEXT_PUBLIC_APP_URL: process.env.NEXT_PUBLIC_APP_URL || '[NOT SET]',
    NEXT_PUBLIC_PIPEDREAM_REDIRECT_URI: process.env.NEXT_PUBLIC_PIPEDREAM_REDIRECT_URI || '[NOT SET]',
