    ...
    <div className="min-h-screen flex flex-col text-white" style={{ background: 'linear-gradient(to bottom, #000000, #0A0A0A)' }}>
      ...
      <section className="flex-1 relative flex flex-col items-center justify-center pt-16 md:pt-20 pb-24 md:pb-32 overflow-hidden">
        ...
        <motion.div 
          ...
          className="mx-4 bg-black/60 border border-[#3CDFFF]/30 rounded-full py-2 px-3 md:px-5 flex flex-col xs:flex-row items-center backdrop-blur-md mb-6 md:mb-8 text-center xs:text-left"
        >
          <span className="whitespace-nowrap mb-1 xs:mb-0">New integrations available!</span>
          <Link href="#integrations" className="ml-0 xs:ml-2 text-sm text-[#3CDFFF] flex items-center justify-center">
            See what's new <FaArrowUpRightFromSquare className="ml-1 w-3 h-3" />
          </Link>
        </motion.div>
