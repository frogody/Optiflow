...
export default function Signup(): JSX.Element {
  ...
  return (
    <div className="min-h-screen flex flex-col dark:bg-black light:bg-white">
      {/* Background design */}
      <div className="fixed inset-0 z-0">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-[#111111] to-black"></div>
        <div className="absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-[#000425]/50 via-transparent to-transparent"></div>
        <div className="absolute -bottom-20 left-1/2 transform -translate-x-1/2 w-[600px] h-[600px] bg-[#3CDFFF]/5 rounded-full filter blur-[80px]"></div>
        <div className="absolute -top-20 left-1/4 transform -translate-x-1/2 w-[300px] h-[300px] bg-[#3CDFFF]/10 rounded-full filter blur-[80px]"></div>
        <div className="absolute top-1/4 right-[10%] w-[350px] h-[350px] bg-[#4AFFD4]/5 rounded-full filter blur-[80px]"></div>
      </div>
      ...
      <div className="flex-1 relative z-10 flex flex-col items-center justify-center p-4">
        <div className="max-w-md w-full mx-auto">
          ...
          {/* Main title */}
          <h1 className="text-3xl md:text-4xl font-bold mb-2 text-center dark:text-white light:text-gray-900">
            Create your account
          </h1>
          <p className="text-md text-center mb-8 dark:text-white/70 light:text-gray-600">
            Join SYNC to start automating your workflows
          </p>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-400">
              ...
              <Link href="/login" className="text-[#22D3EE] hover:text-[#06B6D4] font-medium">
                Sign in
              </Link>
            </p>
          </div>
