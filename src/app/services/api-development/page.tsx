...
export default function APIDevPage(): JSX.Element {
  ...
  "error_handling": { "retry_count": 3,
    "fallback_strategy": "skip_step"
      ...
      response: `{ "workflow_id": "wf_123abc",
  "status": "created",
  "estimated_time": "2m",
  "steps_scheduled": 3,
  ...
  "filters": { "status_code": ["200", "400", "429", "500"],
  ...
  "metrics": {
    ...
    "success_rate": "99.88%",
    "token_usage": 1250000,
    "concurrent_requests": { "peak": 250,
      "average": 85
        }
  },
  "breakdown": {
    "by_endpoint": {
      "/api/v1/predict": { "requests_count": 10234,
        "average_latency": "145ms"
          },
      "/api/v1/workflow": { "requests_count": 5000,
        "average_latency": "178ms"
          }
    },
    "by_status_code": { "200": 15215,
      "400": 12,
      "429": 5,
      "500": 2
        }
  ...
  "input_source": { "type": "s3",
    "bucket": "your-bucket",
    "prefix": "inputs/",
    "format": "jsonl"
      },
  "output_destination": { "type": "s3",
    "bucket": "your-bucket",
    "prefix": "outputs/",
    "format": "jsonl"
      },
  ...
  "notification_config": {
    ...
    "on_error": { "type": "email",
      ...
      response: `{ "batch_job_id": "batch_xyz789",
  "status": "queued",
              ...
              <div className="bg-black/30 backdrop-blur-sm rounded-xl border border-white/10 overflow-hidden">
                ...
                <div className="border-b border-white/10 p-6">
                  <div className="flex items-center space-x-3">
                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${ endpoints[selectedEndpoint].method === 'GET'
            ...
            <div className="flex space-x-2 mb-6">
              {Object.entries(sdkExamples).map(([key, value]) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-lg transition-all duration-300 ${ selectedLanguage === key
                      ? 'bg-[#3CDFFF]/10 border border-[#3CDFFF]/30 text-white'
                      : 'text-gray-400 hover:bg-white/5'
                      }`}
                >
