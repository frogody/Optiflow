...
interface MockPipedreamConnectButtonProps { appSlug: string;
  buttonText?: string;
  className?: string;
 ...
 */
export default function MockPipedreamConnectButton({ appSlug, buttonText, className, onSuccess, onError }: MockPipedreamConnectButtonProps) {
